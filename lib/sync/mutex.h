...
// preserves FIFO ordering using ms-queue
class Mutex {
private:
  class MutexAwaiter
      : public ct::intrusive::AtomicSingleLinkedListElementImpl
...
private:
  ...
  mutable ct::intrusive::lockfree::LockFreeIntrusiveQueue<MutexAwaiter> queue;
  mutable ct::intrusive::lockfree::LockFreeIntrusiveStack<MutexAwaiter> gc;
};
