...
void Coroutine::PromiseType::resume(sched::IntrusiveListScheduler& scheduler) noexcept {
  _current_sched = &scheduler;
  _current_coro = Coroutine(std::coroutine_handle<Coroutine::PromiseType>::from_promise(*this));
...
thread_local sched::IntrusiveListScheduler* Coroutine::_current_sched = nullptr;
thread_local Coroutine Coroutine::_current_coro;
